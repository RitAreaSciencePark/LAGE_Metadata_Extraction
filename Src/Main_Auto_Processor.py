...
def process_single_path(input_path, output_dir):
    ...
    if type_label == "Nanopore":
        ...
        type_label = "FastQC quality control software"   
    elif type_label == "TapeStation":
        type_label = "Sample Quality Control Agilent TapeStation instrument"     
...
def main():
    ...
    VALID_EXTENSIONS = ('.csv', '.txt', '.json', '.md','.xlsx', '.pod5', '.fastq.gz', '.bam', '.bam.bai', '.zip', '.pdf', '.jpeg', '.png', '.html', '.tiff', '.xml', '.xad', '.log')
