...
def process_single_path(input_path, output_dir):
    ...
    # --- NEW: Direct Labeling for PDF/JPEG ---
    if ext in ['.pdf', '.jpeg', '.jpg']:
        type_label = "Supporting Documentation (QC/Acceptance)"
    ...
    if type_label == "Nanopore":
        ...
        type_label = "FastQC quality control report archive generated by FastQC software Babraham Bioinformatics."     
